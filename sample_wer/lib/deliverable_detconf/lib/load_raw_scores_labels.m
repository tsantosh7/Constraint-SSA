function [wolves, sheep, model_wolves, model_sheep, wolve_IDs] = load_raw_scores_labels(filename, working_col, flag)
%
% [imp_scores, gen_scores, imp_model, gen_model] = load_raw_scores_labels(filename, working_col, dev)
...
% Output arg:
%   imp_scores are a set of scores containing impostor accesses
%   gen_scores are a set of scores containg genuine accesses
%   imp_model contains the model labels for the wolves data set
%   gen_model contains the model labels for the sheep data set
%   wolve_IDs contains the identity of the wolves and has the same size as
%   model_wolves
%   
